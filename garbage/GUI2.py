...
class SnakeGame(tk.Tk):
    def __init__(self):
        ...
        self.check = [(170, 150), (140, 80), (60, 340), (50, 370), (270, 20), (10, 50), (130, 140), (320, 380),
                      (10, 350), (120, 340), (260, 140), (280, 370), (170, 0), (100, 270), (210, 170), (90, 130),
                      (210, 60), (50, 240), (60, 220), (220, 380), (160, 20), (290, 340), (70, 240), (50, 350),
                      (180, 390), (230, 360), (120, 40), (20, 140), (180, 50), (140, 60), (240, 170), (290, 230),
                      (100, 230), (220, 130), (170, 40), (380, 100), (340, 150), (100, 290), (240, 170), (350, 140),
                      (200, 30), (140, 20), (200, 250), (170, 40), (130, 360), (200, 130), (310, 250), (290, 90),
                      (160, 80), (150, 350)]
        ...
        print(f"this is {self.food}")
        print(f"this is {self.blocks}")
        # 创建一个四字符代码的视频编码格式
